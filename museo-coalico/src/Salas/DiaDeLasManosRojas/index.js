      ...
      <main className="no-padding position-relative w-100">
        ...
        >
          <p>
            ...
            las Manos Rojas, en contra de la vinculación de los niños y niñas a
            la guerra.
          </p>
        </div>
        ...
        <div id="encabezado" className="d-flex position-absolute row">
          <div className="col-md-7 d-md-block d-none ml-5 pl-3">
            <h1 id="manos">Día de las manos rojas</h1>
            <p>
              El 12 de febrero de cada año se conmemora el Día Internacional de
              las Manos Rojas, en contra de la vinculación de los niños y niñas
              a la guerra.
            </p>
          </div>
